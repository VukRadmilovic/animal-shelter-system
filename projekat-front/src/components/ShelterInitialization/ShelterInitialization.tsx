...
export function ShelterInitialization({shelterService} : ShelterInitializationProps) {
    ...
    const {register, formState: {errors}} = useForm<GeneralInfoForm>({
        defaultValues: {
            name: "",
            address: "",
            capacity: 0,
                                        ...
                                        <Grid container
                                            ...
                                            <Grid item container rowSpacing={1.5} xs={10} sm={10} md={6} lg={6} xl={6} pl={2} pr={2}>
                                                ...
                                                <Grid item xs={12} sm={12} md={12} lg={12} xl={12} mt={9} justifyContent={'right'} sx={{display:'flex'}}>
                                                    <Button variant="contained" type="submit" onClick={handleNext}>Next</Button>
                                                </Grid>
                                            </Grid>
                                        </Grid>
                                 </form>
                                :
                                <AnimalsInitialization animals={animalsWithBreeds}/>
                            }
                    </Grid>
                </Grid>
            </Grid>
